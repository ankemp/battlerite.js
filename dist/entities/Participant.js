...
Participant = function (_Entity_1$Entity) {(0, _inherits3.default)(Participant, _Entity_1$Entity);function Participant() {(0, _classCallCheck3.default)(this, Participant);return (0, _possibleConstructorReturn3.default)(this, (Participant.__proto__ || (0, _getPrototypeOf2.default)(Participant)).apply(this, arguments));}(0, _createClass3.default)(Participant, [{ key: "_set", value: function _set(
        key, value) {
            if (key === "actor") {
                // Actor = champion ID. Use this to find and set the champion object.
                (0, _get3.default)(Participant.prototype.__proto__ || (0, _getPrototypeOf2.default)(Participant.prototype), "_set", this).call(this, "champion", champions_1.getChampionById(value));
            }
            (0, _get3.default)(Participant.prototype.__proto__ || (0, _getPrototypeOf2.default)(Participant.prototype), "_set", this).call(this, key, value);
