...
Asset = function (_Entity_1$Entity) {(0, _inherits3.default)(Asset, _Entity_1$Entity);function Asset() {(0, _classCallCheck3.default)(this, Asset);return (0, _possibleConstructorReturn3.default)(this, (Asset.__proto__ || (0, _getPrototypeOf2.default)(Asset)).apply(this, arguments));}(0, _createClass3.default)(Asset, [{ key: "_set", value: function _set(
        key, value) {
            if (key === "createdAt") {
                value = new Date(value);
            }
            (0, _get3.default)(Asset.prototype.__proto__ || (0, _getPrototypeOf2.default)(Asset.prototype), "_set", this).call(this, key, value);
