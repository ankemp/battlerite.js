...
Roster = function (_Entity_1$Entity) {(0, _inherits3.default)(Roster, _Entity_1$Entity);function Roster() {(0, _classCallCheck3.default)(this, Roster);return (0, _possibleConstructorReturn3.default)(this, (Roster.__proto__ || Object.getPrototypeOf(Roster)).apply(this, arguments));}(0, _createClass3.default)(Roster, [{ key: "_set", value: function _set(
        key, value) {
            if (key === 'won') {
                value = value === 'true' ? true : false;
            }
            (0, _get3.default)(Roster.prototype.__proto__ || Object.getPrototypeOf(Roster.prototype), "_set", this).call(this, key, value);
